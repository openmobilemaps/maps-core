...
public:
    ...
    void render(const /*not-null*/ std::shared_ptr<::RenderingContextInterface> & c_context, const ::RenderPassConfig & c_renderPass, int64_t c_mvpMatrix, int64_t c_modelViewMatrix, bool c_isMasked, double c_screenPixelAsRealMeterFactor) override
    {
        @autoreleasepool {
