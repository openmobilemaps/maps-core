...
private:
    ...
    const jmethodID jconstructor { ::djinni::jniGetMethodID(clazz.get(), "<init>", "(Ljava/lang/String;ILch/ubique/mapscore/shared/map/scheduling/TaskPriority;Lch/ubique/mapscore/shared/map/scheduling/ExecutionEnvironment;)V") };
    const jfieldID field_id { ::djinni::jniGetFieldID(clazz.get(), "id", "Ljava/lang/String;") };
    const jfieldID field_delay { ::djinni::jniGetFieldID(clazz.get(), "delay", "I") };
