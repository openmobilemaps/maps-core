...
#import "MCColorCircleShaderInterface.h"
...
@interface MCColorCircleShaderInterfaceCppProxy : NSObject<MCColorCircleShaderInterface>

- (id)initWithCpp:(const std::shared_ptr<::ColorCircleShaderInterface>&)cppRef;

@end

@implementation MCColorCircleShaderInterfaceCppProxy {
    ::djinni::CppProxyCache::Handle<std::shared_ptr<::ColorCircleShaderInterface>> _cppRefHandle;
}
...
class ColorCircleShaderInterface::ObjcProxy final
: public ::ColorCircleShaderInterface
, private ::djinni::ObjcProxyBase<ObjcType>
{
    friend class ::djinni_generated::ColorCircleShaderInterface;
public:
...
auto ColorCircleShaderInterface::toCpp(ObjcType objc) -> CppType
{
    if (!objc) {
        return nullptr;
    }
    if ([(id)objc isKindOfClass:[MCColorCircleShaderInterfaceCppProxy class]]) {
        return ((MCColorCircleShaderInterfaceCppProxy*)objc)->_cppRefHandle.get();
    }
    return ::djinni::get_objc_proxy<ObjcProxy>(objc);
}

auto ColorCircleShaderInterface::fromCppOpt(const CppOptType& cpp) -> ObjcType
{
    if (!cpp) {
        return nil;
    }
    ...
    return ::djinni::get_cpp_proxy<MCColorCircleShaderInterfaceCppProxy>(cpp);
}
