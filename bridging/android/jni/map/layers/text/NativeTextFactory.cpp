...
CJNIEXPORT jobject JNICALL Java_io_openmobilemaps_mapscore_shared_map_layers_text_TextFactory_createText(JNIEnv* jniEnv, jobject /*this*/, jobject j_text, ::djinni_generated::NativeCoord::JniType j_coordinate, ::djinni_generated::NativeFont::JniType j_font, jobject j_textAnchor, jobject j_textJustify)
{
    try {
