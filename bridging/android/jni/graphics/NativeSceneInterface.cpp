...
CJNIEXPORT void JNICALL Java_io_openmobilemaps_mapscore_shared_graphics_SceneInterface_00024CppProxy_native_1drawFrame(JNIEnv* jniEnv, jobject /*this*/, jlong nativeRef, jobject j_target)
{
    try {
        const auto& ref = ::djinni::objectFromHandleAddress<::SceneInterface>(nativeRef);
        ref->drawFrame(::djinni::Optional<std::optional, ::djinni_generated::NativeRenderTargetInterface>::toCpp(jniEnv, j_target));
    } JNI_TRANSLATE_EXCEPTIONS_RETURN(jniEnv, )
}
