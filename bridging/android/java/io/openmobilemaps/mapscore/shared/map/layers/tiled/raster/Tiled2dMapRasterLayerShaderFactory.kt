...
abstract class Tiled2dMapRasterLayerShaderFactory {
    ...
    abstract fun finalShader(): io.openmobilemaps.mapscore.shared.graphics.shader.ShaderProgramInterface
    ...
    private class CppProxy : Tiled2dMapRasterLayerShaderFactory {
        ...
        override fun finalShader(): io.openmobilemaps.mapscore.shared.graphics.shader.ShaderProgramInterface {
            assert(!this.destroyed.get()) { error("trying to use a destroyed object") }
            return native_finalShader(this.nativeRef)
        }
        private external fun native_finalShader(_nativeRef: Long): io.openmobilemaps.mapscore.shared.graphics.shader.ShaderProgramInterface
    }
}
