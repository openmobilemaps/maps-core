...
NativeRenderTargetTexture::NativeRenderTargetTexture() : ::djinni::JniInterface<::RenderTargetTexture, NativeRenderTargetTexture>("io/openmobilemaps/mapscore/shared/graphics/RenderTargetTexture$CppProxy") {}
...
/*not-null*/ std::shared_ptr<::TextureHolderInterface> NativeRenderTargetTexture::JavaProxy::textureHolder() {
...
CJNIEXPORT void JNICALL Java_io_openmobilemaps_mapscore_shared_graphics_RenderTargetTexture_00024CppProxy_nativeDestroy(JNIEnv* jniEnv, jobject /*this*/, jlong nativeRef)
{
    try {
...
CJNIEXPORT ::djinni_generated::NativeTextureHolderInterface::JniType JNICALL Java_io_openmobilemaps_mapscore_shared_graphics_RenderTargetTexture_00024CppProxy_native_1textureHolder(JNIEnv* jniEnv, jobject /*this*/, jlong nativeRef)
{
    try {
