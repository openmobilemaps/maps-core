...
void NativeExceptionLoggerDelegateInterface::JavaProxy::logMessage(const std::string & c_errorDomain, int32_t c_code, const std::unordered_map<std::string, std::string> & c_customValues) {
...
CJNIEXPORT void JNICALL Java_io_openmobilemaps_mapscore_shared_utils_ExceptionLoggerDelegateInterface_00024CppProxy_native_1logMessage(JNIEnv* jniEnv, jobject /*this*/, jlong nativeRef, jstring j_errorDomain, jint j_code, jobject j_customValues)
{
    try {
        DJINNI_FUNCTION_PROLOGUE1(jniEnv, nativeRef);
