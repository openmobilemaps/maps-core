...
CJNIEXPORT jobject JNICALL Java_io_openmobilemaps_mapscore_shared_map_controls_DefaultTouchHandlerInterface_create(JNIEnv* jniEnv, jobject /*this*/, ::djinni_generated::NativeSchedulerInterface::JniType j_scheduler, jfloat j_density)
{
    try {
