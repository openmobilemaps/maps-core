...
private:
    ...
    public:
        ...
        void setNetworkActivityManager(const std::shared_ptr<::NetworkActivityManagerInterface> & networkActivityManager) override;
    ...
    const jmethodID method_setNetworkActivityManager { ::djinni::jniGetMethodID(clazz.get(), "setNetworkActivityManager", "(Lio/openmobilemaps/mapscore/shared/map/NetworkActivityManagerInterface;)V") };
