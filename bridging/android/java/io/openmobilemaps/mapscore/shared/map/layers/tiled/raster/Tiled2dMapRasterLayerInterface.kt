...
abstract class Tiled2dMapRasterLayerInterface {
    ...
    abstract fun setMinMagFilter(filterType: io.openmobilemaps.mapscore.shared.utils.TextureFilterType)
    ...
    public class CppProxy : Tiled2dMapRasterLayerInterface {
        ...
        override fun setMinMagFilter(filterType: io.openmobilemaps.mapscore.shared.utils.TextureFilterType) {
            assert(!this.destroyed.get()) { error("trying to use a destroyed object") }
            native_setMinMagFilter(this.nativeRef, filterType)
        }
        private external fun native_setMinMagFilter(_nativeRef: Long, filterType: io.openmobilemaps.mapscore.shared.utils.TextureFilterType)
