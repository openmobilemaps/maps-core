...
private:
    ...
    const jmethodID method_onCameraChange { ::djinni::jniGetMethodID(clazz.get(), "onCameraChange", "(Ljava/util/ArrayList;Ljava/util/ArrayList;FFFFFLio/openmobilemaps/mapscore/shared/map/coordinates/Coord;FLio/openmobilemaps/mapscore/shared/map/CameraMode3d;)V") };
};
