...
private:
    ...
    public:
        ...
        void setLines(const ::OwnedBytes & lines, const ::OwnedBytes & indices, const ::Vec3D & origin, bool is3d) override;
    ...
    const jmethodID method_setLines { ::djinni::jniGetMethodID(clazz.get(), "setLines", "(Lio/openmobilemaps/mapscore/shared/graphics/common/OwnedBytes;Lio/openmobilemaps/mapscore/shared/graphics/common/OwnedBytes;Lio/openmobilemaps/mapscore/shared/graphics/common/Vec3D;Z)V") };
