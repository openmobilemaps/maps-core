...
class NativeQuad2dStretchedInstancedInterface final : ::djinni::JniInterface<::Quad2dStretchedInstancedInterface, NativeQuad2dStretchedInstancedInterface> {
public:
    ...
    ~NativeQuad2dStretchedInstancedInterface();

    static CppType toCpp(JNIEnv* jniEnv, JniType j) { return ::djinni::JniClass<NativeQuad2dStretchedInstancedInterface>::get()._fromJava(jniEnv, j); }
    static ::djinni::LocalRef<JniType> fromCppOpt(JNIEnv* jniEnv, const CppOptType& c) { return {jniEnv, ::djinni::JniClass<NativeQuad2dStretchedInstancedInterface>::get()._toJava(jniEnv, c)}; }
    static ::djinni::LocalRef<JniType> fromCpp(JNIEnv* jniEnv, const CppType& c) { return fromCppOpt(jniEnv, c); }

private:
    NativeQuad2dStretchedInstancedInterface();
    friend ::djinni::JniClass<NativeQuad2dStretchedInstancedInterface>;
    friend ::djinni::JniInterface<::Quad2dStretchedInstancedInterface, NativeQuad2dStretchedInstancedInterface>;

    class JavaProxy final : ::djinni::JavaProxyHandle<JavaProxy>, public ::Quad2dStretchedInstancedInterface
    {
    public:
        JavaProxy(JniType j);
        ~JavaProxy();
        ...
        void setStretchInfos(const ::SharedBytes & values) override;
    ...
    private:
        friend ::djinni::JniInterface<::Quad2dStretchedInstancedInterface, ::djinni_generated::NativeQuad2dStretchedInstancedInterface>;
    };

    const ::djinni::GlobalRef<jclass> clazz { ::djinni::jniFindClass("io/openmobilemaps/mapscore/shared/graphics/objects/Quad2dStretchedInstancedInterface") };
    ...
    const jmethodID method_setStretchInfos { ::djinni::jniGetMethodID(clazz.get(), "setStretchInfos", "(Lio/openmobilemaps/mapscore/shared/graphics/common/SharedBytes;)V") };
