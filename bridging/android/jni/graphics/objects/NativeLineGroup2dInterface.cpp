...
void NativeLineGroup2dInterface::JavaProxy::setScalingFactor(float c_factor) {
    auto jniEnv = ::djinni::jniGetThreadEnv();
    ::djinni::JniLocalScope jscope(jniEnv, 10);
    const auto& data = ::djinni::JniClass<::djinni_generated::NativeLineGroup2dInterface>::get();
...
CJNIEXPORT void JNICALL Java_io_openmobilemaps_mapscore_shared_graphics_objects_LineGroup2dInterface_00024CppProxy_native_1setScalingFactor(JNIEnv* jniEnv, jobject /*this*/, jlong nativeRef, jfloat j_factor)
{
    try {
        const auto& ref = ::djinni::objectFromHandleAddress<::LineGroup2dInterface>(nativeRef);
