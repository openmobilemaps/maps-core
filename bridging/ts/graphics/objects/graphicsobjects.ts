...
import type { OwnedBytes, Quad2dD, Quad3dD, RectD, SharedBytes, Vec2D, Vec2F, Vec3D } from "@djinni/maps-core/graphics/common/common"
...
export interface GraphicsObjectFactoryInterface {
    ...
    createTexturedPolygon(shader: ShaderProgramInterface): TexturedPolygonInterface;
...
export interface Quad2dInterface {
    ...
    loadDualTexture(context: RenderingContextInterface, textureHolder: TextureHolderInterface, elevationHolder: TextureHolderInterface | undefined): void;
    /**
     ...
     */
    loadTextures(context: RenderingContextInterface, textureHolder: TextureHolderInterface, lookupHolder: TextureHolderInterface | undefined, elevationHolder: TextureHolderInterface | undefined): void;
    removeTexture(): void;
    asGraphicsObject(): GraphicsObjectInterface;
    asMaskingObject(): MaskingObjectInterface;
}

export interface TexturedPolygonInterface {
...
export interface LineGroup2dInterface {
    setLines(lines: OwnedBytes, indices: OwnedBytes, origin: Vec3D, is3d: boolean): void;
    asGraphicsObject(): GraphicsObjectInterface;
}
