...
private:
    ...
    const jmethodID method_finalShader { ::djinni::jniGetMethodID(clazz.get(), "finalShader", "()Lio/openmobilemaps/mapscore/shared/graphics/shader/InterpolationShaderInterface;") };
};
