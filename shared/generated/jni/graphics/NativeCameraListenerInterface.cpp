...
void NativeCameraListenerInterface::JavaProxy::onPositionChanged(const ::Vec3F & c_position) {
    ...
    jniEnv->CallVoidMethod(Handle::get().get(), data.method_onPositionChanged,
                           ::djinni::get(::djinni_generated::NativeVec3F::fromCpp(jniEnv, c_position)));
...
CJNIEXPORT void JNICALL Java_ch_ubique_mapscore_shared_graphics_CameraListenerInterface_00024CppProxy_native_1onPositionChanged(JNIEnv* jniEnv, jobject /*this*/, jlong nativeRef, ::djinni_generated::NativeVec3F::JniType j_position)
{
    try {
        DJINNI_FUNCTION_PROLOGUE1(jniEnv, nativeRef);
        const auto& ref = ::djinni::objectFromHandleAddress<::CameraListenerInterface>(nativeRef);
        ref->onPositionChanged(::djinni_generated::NativeVec3F::toCpp(jniEnv, j_position));
    } JNI_TRANSLATE_EXCEPTIONS_RETURN(jniEnv, )
}
