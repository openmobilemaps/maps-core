...
public:
    ...
    static ::RectCoord convertMvpMatrixToViewportBounds(int64_t mvpMatrix, const ::Vec2I & viewport);

    static float convertMvpMatrixToRotation(int64_t mvpMatrix, const ::Vec2I & viewport);
