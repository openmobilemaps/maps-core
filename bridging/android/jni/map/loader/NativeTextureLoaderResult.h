...
private:
    ...
    const jmethodID jconstructor { ::djinni::jniGetMethodID(clazz.get(), "<init>", "(Lio/openmobilemaps/mapscore/shared/graphics/objects/TextureHolderInterface;Ljava/lang/String;Lio/openmobilemaps/mapscore/shared/map/loader/LoaderStatus;)V") };
