...
class Matrix
{
  public:
    ...
    static void orthoM(std::vector<float>& m, int mOffset, float left, float right, float bottom, float top,
                       float near, float far);
    static void frustumM(std::vector<float>& m, int offset, float left, float right, float bottom, float top,
                         float near, float far);
    ...
    static void setLookAtM(std::vector<float>& rm, int rmOffset, float eyeX, float eyeY, float eyeZ, float centerX,
                           float centerY, float centerZ, float upX, float upY, float upZ);

    static void scaleM(std::vector<float>& sm, int smOffset, std::vector<float>& m, int mOffset, float x, float y,
                       float z);
    static void scaleM(std::vector<float>& m, int mOffset, float x, float y, float z);
    static void translateM(std::vector<float>& tm, int tmOffset, std::vector<float>& m, int mOffset, float x,
                           float y, float z);
    ...
    static void multiplyMM(std::vector<float>& r, int resultOffset, std::vector<float>& lhs, int lhsOffset, std::vector<float>& rhs, int rhsOffset);
