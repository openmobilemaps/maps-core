...
CJNIEXPORT void JNICALL Java_io_openmobilemaps_mapscore_shared_utils_ExceptionLoggerInterface_00024CppProxy_setLoggerDelegate(JNIEnv* jniEnv, jobject /*this*/, jobject j_delegate)
{
    try {
