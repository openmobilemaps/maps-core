...
actual class KMMapCameraInterface actual public constructor(
    ...
    actual fun asMapCamera3d(): KMMapCamera3dInterface? {
        ...
        return result?.let { (it as MapCoreSharedModule.MCMapCamera3dInterface).asKmp() }
    }
...
public fun MapCoreSharedModule.MCMapCameraInterface.asKmp(): KMMapCameraInterface = KMMapCameraInterface(this)
