...
private:
    ...
    public:
        ...
        void renderAsMask(const /*not-null*/ std::shared_ptr<::RenderingContextInterface> & context, const ::RenderPassConfig & renderPass, int64_t viewMatrix, int64_t projectionMatrix, int64_t mMatrix, const ::Vec3F & origin, double screenPixelAsRealMeterFactor) override;
    ...
    const jmethodID method_renderAsMask { ::djinni::jniGetMethodID(clazz.get(), "renderAsMask", "(Lio/openmobilemaps/mapscore/shared/graphics/RenderingContextInterface;Lio/openmobilemaps/mapscore/shared/graphics/RenderPassConfig;JJJLio/openmobilemaps/mapscore/shared/graphics/common/Vec3F;D)V") };
};
