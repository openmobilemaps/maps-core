...
void NativeRendererInterface::JavaProxy::drawFrame(const std::shared_ptr<::RenderingContextInterface> & c_renderingContext, const std::shared_ptr<::CameraInterface> & c_camera, const std::vector<std::shared_ptr<::RenderTargetTexture>> & c_additionalTargets) {
    auto jniEnv = ::djinni::jniGetThreadEnv();
    ::djinni::JniLocalScope jscope(jniEnv, 10);
    const auto& data = ::djinni::JniClass<::djinni_generated::NativeRendererInterface>::get();
    jniEnv->CallVoidMethod(Handle::get().get(), data.method_drawFrame,
                           ...
                           ::djinni::get(::djinni::List<::djinni_generated::NativeRenderTargetTexture>::fromCpp(jniEnv, c_additionalTargets)));
    ::djinni::jniExceptionCheck(jniEnv);
}
...
CJNIEXPORT void JNICALL Java_io_openmobilemaps_mapscore_shared_graphics_RendererInterface_00024CppProxy_native_1drawFrame(JNIEnv* jniEnv, jobject /*this*/, jlong nativeRef, jobject j_renderingContext, jobject j_camera, jobject j_additionalTargets)
{
    try {
        DJINNI_FUNCTION_PROLOGUE1(jniEnv, nativeRef);
        const auto& ref = ::djinni::objectFromHandleAddress<::RendererInterface>(nativeRef);
        ref->drawFrame(::djinni_generated::NativeRenderingContextInterface::toCpp(jniEnv, j_renderingContext),
                       ...
                       ::djinni::List<::djinni_generated::NativeRenderTargetTexture>::toCpp(jniEnv, j_additionalTargets));
    } JNI_TRANSLATE_EXCEPTIONS_RETURN(jniEnv, )
}
