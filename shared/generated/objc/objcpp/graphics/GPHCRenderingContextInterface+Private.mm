...
@interface GPHCRenderingContextInterfaceCppProxy : NSObject<GPHCRenderingContextInterface>

- (id)initWithCpp:(const std::shared_ptr<::RenderingContextInterface>&)cppRef;

@end

@implementation GPHCRenderingContextInterfaceCppProxy {
...
auto RenderingContextInterface::toCpp(ObjcType objc) -> CppType
{
    ...
    if ([(id)objc isKindOfClass:[GPHCRenderingContextInterfaceCppProxy class]]) {
        return ((GPHCRenderingContextInterfaceCppProxy*)objc)->_cppRefHandle.get();
    }
...
auto RenderingContextInterface::fromCppOpt(const CppOptType& cpp) -> ObjcType
{
    ...
    return ::djinni::get_cpp_proxy<GPHCRenderingContextInterfaceCppProxy>(cpp);
}
