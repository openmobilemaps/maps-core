...
@interface GPHCLineShaderProgramInterfaceCppProxy : NSObject<GPHCLineShaderProgramInterface>

- (id)initWithCpp:(const std::shared_ptr<::LineShaderProgramInterface>&)cppRef;

@end

@implementation GPHCLineShaderProgramInterfaceCppProxy {
...
auto LineShaderProgramInterface::toCpp(ObjcType objc) -> CppType
{
    ...
    if ([(id)objc isKindOfClass:[GPHCLineShaderProgramInterfaceCppProxy class]]) {
        return ((GPHCLineShaderProgramInterfaceCppProxy*)objc)->_cppRefHandle.get();
    }
...
auto LineShaderProgramInterface::fromCppOpt(const CppOptType& cpp) -> ObjcType
{
    ...
    return ::djinni::get_cpp_proxy<GPHCLineShaderProgramInterfaceCppProxy>(cpp);
}
