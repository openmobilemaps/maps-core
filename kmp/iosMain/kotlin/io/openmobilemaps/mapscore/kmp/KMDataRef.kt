...
public fun KMDataRef.asPlatform(): platform.Foundation.NSData = asNSData()
public fun platform.Foundation.NSData.asKmp(): KMDataRef = KMDataRefPlatformWrapper(this)
