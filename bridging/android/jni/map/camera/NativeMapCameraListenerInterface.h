...
private:
    ...
    const jmethodID method_onCameraChange { ::djinni::jniGetMethodID(clazz.get(), "onCameraChange", "(Ljava/util/ArrayList;Ljava/util/ArrayList;FFFFFLio/openmobilemaps/mapscore/shared/map/coordinates/Coord;F)V") };
};
