...
public abstract class GraphicsObjectInterface {
    ...
    public abstract void setup(ch.ubique.mapscore.shared.graphics.RenderingContextInterface context);
    ...
    private static final class CppProxy extends GraphicsObjectInterface
    {
        ...
        @Override
        public void setup(ch.ubique.mapscore.shared.graphics.RenderingContextInterface context)
        {
            assert !this.destroyed.get() : "trying to use a destroyed object";
            native_setup(this.nativeRef, context);
        }
        private native void native_setup(long _nativeRef, ch.ubique.mapscore.shared.graphics.RenderingContextInterface context);
