...
#include "NativeTextureInterpolationShaderInterface.h"
...
/*not-null*/ std::shared_ptr<::TextureInterpolationShaderInterface> NativeShaderFactoryInterface::JavaProxy::createTextureInterpolationShader() {
    auto jniEnv = ::djinni::jniGetThreadEnv();
    ::djinni::JniLocalScope jscope(jniEnv, 10);
    const auto& data = ::djinni::JniClass<::djinni_generated::NativeShaderFactoryInterface>::get();
    auto jret = jniEnv->CallObjectMethod(Handle::get().get(), data.method_createTextureInterpolationShader);
    ::djinni::jniExceptionCheck(jniEnv);
    return ::djinni_generated::NativeTextureInterpolationShaderInterface::toCpp(jniEnv, jret);
}
...
CJNIEXPORT jobject JNICALL Java_io_openmobilemaps_mapscore_shared_graphics_shader_ShaderFactoryInterface_00024CppProxy_native_1createTextureInterpolationShader(JNIEnv* jniEnv, jobject /*this*/, jlong nativeRef)
{
    try {
        const auto& ref = ::djinni::objectFromHandleAddress<::ShaderFactoryInterface>(nativeRef);
        auto r = ref->createTextureInterpolationShader();
        return ::djinni::release(::djinni_generated::NativeTextureInterpolationShaderInterface::fromCpp(jniEnv, r));
    } JNI_TRANSLATE_EXCEPTIONS_RETURN(jniEnv, 0 /* value doesn't matter */)
}
