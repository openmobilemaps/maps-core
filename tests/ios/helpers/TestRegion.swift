...
extension TestRegion {
    ...
    static let all: [TestRegion] = [
        TestRegion(identifier: "Zürich", topLeft: .init(latitude: 47.434, longitude: 8.488), bottomRight: .init(latitude: 47.322, longitude: 8.631)), // City
        ...
        TestRegion(identifier: "Aletsch Glacier", topLeft: .init(latitude: 46.535, longitude: 8.093), bottomRight: .init(latitude: 46.387, longitude: 8.135)), // Glacier
