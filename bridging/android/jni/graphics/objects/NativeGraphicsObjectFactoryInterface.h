...
private:
    ...
    public:
        ...
        /*not-null*/ std::shared_ptr<::Quad2dInterpolatedInterface> createQuadInterpolated(const /*not-null*/ std::shared_ptr<::ShaderProgramInterface> & shader) override;
    ...
    const jmethodID method_createQuadInterpolated { ::djinni::jniGetMethodID(clazz.get(), "createQuadInterpolated", "(Lio/openmobilemaps/mapscore/shared/graphics/shader/ShaderProgramInterface;)Lio/openmobilemaps/mapscore/shared/graphics/objects/Quad2dInterpolatedInterface;") };
