...
abstract class MapInterface {
    ...
    abstract fun createRenderTargetTexture(): RenderTargetTexture
    ...
    private class CppProxy : MapInterface {
        ...
        override fun createRenderTargetTexture(): RenderTargetTexture {
            assert(!this.destroyed.get()) { error("trying to use a destroyed object") }
            return native_createRenderTargetTexture(this.nativeRef)
        }
        private external fun native_createRenderTargetTexture(_nativeRef: Long): RenderTargetTexture
