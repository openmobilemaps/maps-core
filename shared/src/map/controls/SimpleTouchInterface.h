...
public:
    virtual bool onClickUnconfirmed(const ::Vec2F &posScreen) {
        return false;
    };

    virtual bool onClickConfirmed(const ::Vec2F &posScreen) {
        return false;
    };
    ...
    virtual bool onLongPress(const ::Vec2F &posScreen) {
        return false;
    };
    ...
    virtual bool onMoveComplete() {
        return false;
    };

    virtual bool onTwoFingerClick(const ::Vec2F &posScreen1, const ::Vec2F &posScreen2) {
        return false;
    };
