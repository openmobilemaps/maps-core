...
private:
    ...
    const jmethodID jconstructor { ::djinni::jniGetMethodID(clazz.get(), "<init>", "(Ljava/lang/String;Lch/ubique/mapscore/shared/map/scheduling/TaskPriority;Lch/ubique/mapscore/shared/map/scheduling/ExecutionEnvironment;)V") };
