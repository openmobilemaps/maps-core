...
fun main() {
    ...
    cam.moveToCenterPositionZoom(
        Coord(CoordinateSystemIdentifiers.EPSG4326(), 8.2, 46.8, 0.0),
        zooms[8].zoom,
        false
    );// 97656.25 * 0.1 * dpi, false)
...
fun tileBBox(col: Int, row: Int, m: Tiled2dMapZoomLevelInfo): RectCoord {
    ...
    return RectCoord(
        Coord(m.bounds.topLeft.systemIdentifier, leftX, upperY, 0.0),
