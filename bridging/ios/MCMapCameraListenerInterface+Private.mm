...
public:
    ...
    void onCameraChange(const std::vector<float> & c_viewMatrix, const std::vector<float> & c_projectionMatrix, const ::Vec3F & c_origin, float c_verticalFov, float c_horizontalFov, float c_width, float c_height, float c_focusPointAltitude, const ::Coord & c_focusPointPosition, float c_zoom, ::CameraMode3d c_mode) override
    {
        @autoreleasepool {
