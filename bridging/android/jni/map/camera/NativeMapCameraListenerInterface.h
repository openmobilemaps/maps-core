...
private:
    ...
    public:
        ...
        void onCameraChange(const std::vector<float> & viewMatrix, const std::vector<float> & projectionMatrix, const ::Vec3F & origin, float verticalFov, float horizontalFov, float width, float height, float focusPointAltitude, const ::Coord & focusPointPosition, float zoom, ::CameraMode3d mode) override;
    ...
    const jmethodID method_onCameraChange { ::djinni::jniGetMethodID(clazz.get(), "onCameraChange", "(Ljava/util/ArrayList;Ljava/util/ArrayList;Lio/openmobilemaps/mapscore/shared/graphics/common/Vec3F;FFFFFLio/openmobilemaps/mapscore/shared/map/coordinates/Coord;FLio/openmobilemaps/mapscore/shared/map/CameraMode3d;)V") };
};
