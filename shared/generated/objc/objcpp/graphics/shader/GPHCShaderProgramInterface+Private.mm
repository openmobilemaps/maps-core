...
@interface GPHCShaderProgramInterfaceCppProxy : NSObject<GPHCShaderProgramInterface>

- (id)initWithCpp:(const std::shared_ptr<::ShaderProgramInterface>&)cppRef;

@end

@implementation GPHCShaderProgramInterfaceCppProxy {
...
auto ShaderProgramInterface::toCpp(ObjcType objc) -> CppType
{
    ...
    if ([(id)objc isKindOfClass:[GPHCShaderProgramInterfaceCppProxy class]]) {
        return ((GPHCShaderProgramInterfaceCppProxy*)objc)->_cppRefHandle.get();
    }
...
auto ShaderProgramInterface::fromCppOpt(const CppOptType& cpp) -> ObjcType
{
    ...
    return ::djinni::get_cpp_proxy<GPHCShaderProgramInterfaceCppProxy>(cpp);
}
