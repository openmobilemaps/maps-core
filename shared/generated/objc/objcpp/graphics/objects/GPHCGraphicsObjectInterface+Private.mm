...
- (void)render:(nullable id<GPHCRenderingContextInterface>)context
    renderPass:(nullable id<GPHCRenderPassInterface>)renderPass
     mvpMatrix:(int64_t)mvpMatrix {
    try {
        _cppRefHandle.get()->render(::djinni_generated::RenderingContextInterface::toCpp(context),
                                    ::djinni_generated::RenderPassInterface::toCpp(renderPass),
...
public:
    ...
    void setup(const std::shared_ptr<::RenderingContextInterface> & c_context) override
    {
        @autoreleasepool {
    ...
    void render(const std::shared_ptr<::RenderingContextInterface> & c_context, const std::shared_ptr<::RenderPassInterface> & c_renderPass, int64_t c_mvpMatrix) override
    {
        @autoreleasepool {
            [djinni_private_get_proxied_objc_object() render:(::djinni_generated::RenderingContextInterface::fromCpp(c_context))
                                                  renderPass:(::djinni_generated::RenderPassInterface::fromCpp(c_renderPass))
