...
actual class KMCpuPerformanceLoggerInterface actual public constructor(
    ...
    actual companion object
    {
        ...
        actual fun create(): KMCpuPerformanceLoggerInterface {
            ...
            return (result as io.openmobilemaps.mapscore.shared.map.CpuPerformanceLoggerInterface).asKmp()
        }
...
public fun KMCpuPerformanceLoggerInterface.asPlatform(): CpuPerformanceLoggerInterface = nativeHandle as CpuPerformanceLoggerInterface
