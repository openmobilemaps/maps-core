...
- (void)logMessage:(nonnull NSString *)errorDomain
    ...
    try {
        _cppRefHandle.get()->logMessage(::djinni::String::toCpp(errorDomain),
                                        ...
                                        ::djinni::String::toCpp(functionName),
...
public:
    ...
    void logMessage(const std::string & c_errorDomain, int32_t c_code, const std::unordered_map<std::string, std::string> & c_customValues, const std::string & c_functionName, const std::string & c_file, int32_t c_line) override
    {
        @autoreleasepool {
            [djinni_private_get_proxied_objc_object() logMessage:(::djinni::String::fromCpp(c_errorDomain))
                                                    ...
                                                    functionName:(::djinni::String::fromCpp(c_functionName))
