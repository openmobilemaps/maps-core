...
- (nullable id<MCIcosahedronInterface>)createIcosahedronObject:(nullable id<MCShaderProgramInterface>)shader {
    try {
        ...
        return ::djinni_generated::IcosahedronInterface::fromCpp(objcpp_result_);
    } DJINNI_TRANSLATE_EXCEPTIONS()
}
...
public:
    ...
    /*not-null*/ std::shared_ptr<::IcosahedronInterface> createIcosahedronObject(const /*not-null*/ std::shared_ptr<::ShaderProgramInterface> & c_shader) override
    {
        @autoreleasepool {
            auto objcpp_result_ = [djinni_private_get_proxied_objc_object() createIcosahedronObject:(::djinni_generated::ShaderProgramInterface::fromCpp(c_shader))];
            return ::djinni_generated::IcosahedronInterface::toCpp(objcpp_result_);
        }
    }
