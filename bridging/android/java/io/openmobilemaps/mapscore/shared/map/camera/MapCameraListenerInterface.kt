...
abstract class MapCameraListenerInterface {
    ...
    abstract fun onCameraChange(viewMatrix: ArrayList<Float>, projectionMatrix: ArrayList<Float>, origin: io.openmobilemaps.mapscore.shared.graphics.common.Vec3D, verticalFov: Float, horizontalFov: Float, width: Float, height: Float, focusPointAltitude: Float, focusPointPosition: io.openmobilemaps.mapscore.shared.map.coordinates.Coord, zoom: Float, mode: io.openmobilemaps.mapscore.shared.map.CameraMode3d)
