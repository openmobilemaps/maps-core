...
TestingLayer::TestingLayer(std::shared_ptr<GraphicsObjectFactoryInterface> graphicsObjectFactory, std::shared_ptr<ShaderFactoryInterface> shaderFactory) {
    ...
    object->setPositions({
        Vec2F(2483750.172633792, 1110749.9292120978),
        Vec2F(2484250.1398714944, 1121749.9210555588),
        Vec2F(2493750.1353852837, 1124749.932216558),
        Vec2F(2497750.1114729308, 1134249.9298414628),
        Vec2F(2490250.0966190984, 1140749.9155252017),
        Vec2F(2496750.055996045, 1161249.912233307),
        Vec2F(2519750.007658271, 1181249.9364165873),
        Vec2F(2521249.96731385, 1200749.9402584787),
        Vec2F(2527249.951458698, 1207249.9519499454),
        Vec2F(2540249.945291664, 1210249.9739189378),
        Vec2F(2539249.9310220755, 1216749.9768762388),
        Vec2F(2559249.911010254, 1233750.0250706144),
        Vec2F(2567249.906174939, 1243250.0498991741),
        Vec2F(2556249.887021004, 1242750.0333215091),
        Vec2F(2566749.861025399, 1264250.0877615795),
        Vec2F(2584249.9217585553, 1262750.1053500893)
    });
