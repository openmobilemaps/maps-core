...
auto NativeRenderPassConfig::fromCpp(JNIEnv* jniEnv, const CppType& c) -> ::djinni::LocalRef<JniType> {
    ...
    auto r = ::djinni::LocalRef<JniType>{jniEnv->NewObject(data.clazz.get(), data.jconstructor,
                                                           ...
                                                           ::djinni::get(::djinni::Optional<std::optional, ::djinni_generated::NativeRenderTargetTexture>::fromCpp(jniEnv, c.renderTargetTexture)))};
...
auto NativeRenderPassConfig::toCpp(JNIEnv* jniEnv, JniType j) -> CppType {
    ...
    return {::djinni::I32::toCpp(jniEnv, jniEnv->GetIntField(j, data.field_renderPassIndex)),
            ::djinni::Optional<std::optional, ::djinni_generated::NativeRenderTargetTexture>::toCpp(jniEnv, jniEnv->GetObjectField(j, data.field_renderTargetTexture))};
}
