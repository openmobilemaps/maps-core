...
private:
    ...
    const jmethodID jconstructor { ::djinni::jniGetMethodID(clazz.get(), "<init>", "(Lio/openmobilemaps/mapscore/shared/map/layers/ColorStateList;Lio/openmobilemaps/mapscore/shared/map/layers/ColorStateList;FFLio/openmobilemaps/mapscore/shared/map/layers/SizeType;FLjava/util/ArrayList;Lio/openmobilemaps/mapscore/shared/map/layers/line/LineCapType;FLio/openmobilemaps/mapscore/shared/map/layers/line/LineDashCapType;)V") };
    ...
    const jfieldID field_lineDashCap { ::djinni::jniGetFieldID(clazz.get(), "lineDashCap", "Lio/openmobilemaps/mapscore/shared/map/layers/line/LineDashCapType;") };
};
