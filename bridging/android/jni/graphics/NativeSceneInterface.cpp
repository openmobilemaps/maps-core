...
CJNIEXPORT jobject JNICALL Java_io_openmobilemaps_mapscore_shared_graphics_SceneInterface_00024CppProxy_createWithOpenGl(JNIEnv* jniEnv, jobject /*this*/)
{
    try {
        DJINNI_FUNCTION_PROLOGUE0(jniEnv);
...
CJNIEXPORT void JNICALL Java_io_openmobilemaps_mapscore_shared_graphics_SceneInterface_00024CppProxy_native_1drawFrame(JNIEnv* jniEnv, jobject /*this*/, jlong nativeRef, jobject j_additionalTargets)
{
    try {
        DJINNI_FUNCTION_PROLOGUE1(jniEnv, nativeRef);
        const auto& ref = ::djinni::objectFromHandleAddress<::SceneInterface>(nativeRef);
        ref->drawFrame(::djinni::List<::djinni_generated::NativeRenderTargetTexture>::toCpp(jniEnv, j_additionalTargets));
    } JNI_TRANSLATE_EXCEPTIONS_RETURN(jniEnv, )
}
