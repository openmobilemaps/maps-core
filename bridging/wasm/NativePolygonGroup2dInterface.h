...
struct NativePolygonGroup2dInterface : ::djinni::JsInterface<::PolygonGroup2dInterface, NativePolygonGroup2dInterface> {
    ...
    static JsType fromCpp(const CppType& c) {
        ::djinni::checkForNull(c.get(), "NativePolygonGroup2dInterface::fromCpp");
        return fromCppOpt(c);
    }
