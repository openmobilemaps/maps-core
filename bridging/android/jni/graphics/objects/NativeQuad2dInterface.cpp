...
void NativeQuad2dInterface::JavaProxy::setFrame(const ::Quad3dD & c_frame, const ::RectD & c_textureCoordinates) {
...
CJNIEXPORT void JNICALL Java_io_openmobilemaps_mapscore_shared_graphics_objects_Quad2dInterface_00024CppProxy_native_1setFrame(JNIEnv* jniEnv, jobject /*this*/, jlong nativeRef, ::djinni_generated::NativeQuad3dD::JniType j_frame, ::djinni_generated::NativeRectD::JniType j_textureCoordinates)
{
    try {
