...
void NativePolygon3dInterface::JavaProxy::setTileInfo(int32_t c_x, int32_t c_y, int32_t c_z, int32_t c_offset) {
    auto jniEnv = ::djinni::jniGetThreadEnv();
    ::djinni::JniLocalScope jscope(jniEnv, 10);
    const auto& data = ::djinni::JniClass<::djinni_generated::NativePolygon3dInterface>::get();
...
CJNIEXPORT void JNICALL Java_io_openmobilemaps_mapscore_shared_graphics_objects_Polygon3dInterface_00024CppProxy_native_1setTileInfo(JNIEnv* jniEnv, jobject /*this*/, jlong nativeRef, jint j_x, jint j_y, jint j_z, jint j_offset)
{
    try {
        const auto& ref = ::djinni::objectFromHandleAddress<::Polygon3dInterface>(nativeRef);
