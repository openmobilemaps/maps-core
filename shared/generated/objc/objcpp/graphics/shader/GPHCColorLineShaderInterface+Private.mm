...
#import "GPHCColorLineShaderInterface.h"
...
@interface GPHCColorLineShaderInterfaceCppProxy : NSObject<GPHCColorLineShaderInterface>

- (id)initWithCpp:(const std::shared_ptr<::ColorLineShaderInterface>&)cppRef;

@end

@implementation GPHCColorLineShaderInterfaceCppProxy {
...
auto ColorLineShaderInterface::toCpp(ObjcType objc) -> CppType
{
    ...
    if ([(id)objc isKindOfClass:[GPHCColorLineShaderInterfaceCppProxy class]]) {
        return ((GPHCColorLineShaderInterfaceCppProxy*)objc)->_cppRefHandle.get();
    }
...
auto ColorLineShaderInterface::fromCppOpt(const CppOptType& cpp) -> ObjcType
{
    ...
    return ::djinni::get_cpp_proxy<GPHCColorLineShaderInterfaceCppProxy>(cpp);
}
