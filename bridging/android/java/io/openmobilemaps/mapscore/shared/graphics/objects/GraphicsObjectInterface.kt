...
abstract class GraphicsObjectInterface {
    ...
    abstract fun render(context: io.openmobilemaps.mapscore.shared.graphics.RenderingContextInterface, renderPass: io.openmobilemaps.mapscore.shared.graphics.RenderPassConfig, viewMatrix: Long, projectionMatrix: Long, mMatrix: Long, origin: io.openmobilemaps.mapscore.shared.graphics.common.Vec3F, isMasked: Boolean, screenPixelAsRealMeterFactor: Double)
    ...
    private class CppProxy : GraphicsObjectInterface {
        ...
        override fun render(context: io.openmobilemaps.mapscore.shared.graphics.RenderingContextInterface, renderPass: io.openmobilemaps.mapscore.shared.graphics.RenderPassConfig, viewMatrix: Long, projectionMatrix: Long, mMatrix: Long, origin: io.openmobilemaps.mapscore.shared.graphics.common.Vec3F, isMasked: Boolean, screenPixelAsRealMeterFactor: Double) {
            assert(!this.destroyed.get()) { error("trying to use a destroyed object") }
            native_render(this.nativeRef, context, renderPass, viewMatrix, projectionMatrix, mMatrix, origin, isMasked, screenPixelAsRealMeterFactor)
        }
