...
// Convert EPSG:3857 coordinates to the unit sphere in cartesian coordinates (0/0/EARTH_RADIUS maps to 1/0/0)
class EPSG3857ToUnitSphereCartConverter : public CoordinateConverterInterface {
public:
    EPSG3857ToUnitSphereCartConverter() {}
