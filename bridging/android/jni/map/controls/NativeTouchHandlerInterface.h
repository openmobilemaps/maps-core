...
private:
    ...
    public:
        ...
        void insertListener(const /*not-null*/ std::shared_ptr<::TouchInterface> & listener, int32_t index) override;
        void addListener(const /*not-null*/ std::shared_ptr<::TouchInterface> & listener) override;
        void removeListener(const /*not-null*/ std::shared_ptr<::TouchInterface> & listener) override;
