...
void NativeGraphicsObjectInterface::JavaProxy::render(const /*not-null*/ std::shared_ptr<::RenderingContextInterface> & c_context, const ::RenderPassConfig & c_renderPass, int64_t c_viewMatrix, int64_t c_projectionMatrix, int64_t c_mMatrix, const ::Vec3D & c_origin, bool c_isMasked, double c_screenPixelAsRealMeterFactor) {
    auto jniEnv = ::djinni::jniGetThreadEnv();
    ::djinni::JniLocalScope jscope(jniEnv, 10);
    const auto& data = ::djinni::JniClass<::djinni_generated::NativeGraphicsObjectInterface>::get();
    jniEnv->CallVoidMethod(Handle::get().get(), data.method_render,
                           ...
                           ::djinni::get(::djinni::I64::fromCpp(jniEnv, c_viewMatrix)),
                           ::djinni::get(::djinni::I64::fromCpp(jniEnv, c_projectionMatrix)),
...
CJNIEXPORT void JNICALL Java_io_openmobilemaps_mapscore_shared_graphics_objects_GraphicsObjectInterface_00024CppProxy_native_1render(JNIEnv* jniEnv, jobject /*this*/, jlong nativeRef, ::djinni_generated::NativeRenderingContextInterface::JniType j_context, ::djinni_generated::NativeRenderPassConfig::JniType j_renderPass, jlong j_viewMatrix, jlong j_projectionMatrix, jlong j_mMatrix, ::djinni_generated::NativeVec3D::JniType j_origin, jboolean j_isMasked, jdouble j_screenPixelAsRealMeterFactor)
{
    try {
        ...
        ref->render(::djinni_generated::NativeRenderingContextInterface::toCpp(jniEnv, j_context),
                    ...
                    ::djinni::I64::toCpp(jniEnv, j_viewMatrix),
                    ::djinni::I64::toCpp(jniEnv, j_projectionMatrix),
