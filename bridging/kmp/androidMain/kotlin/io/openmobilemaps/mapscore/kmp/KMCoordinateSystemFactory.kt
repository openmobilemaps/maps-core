...
actual class KMCoordinateSystemFactory actual public constructor(
    ...
    actual companion object
    {
        ...
        actual fun getEpsg4326System2d(): KMMapCoordinateSystem {
            val result = CoordinateSystemFactory.getEpsg4326System2d()
            return (result as io.openmobilemaps.mapscore.shared.map.coordinates.MapCoordinateSystem).asKmp()
        }
        ...
        actual fun getSystemFor(identifier: Int): KMMapCoordinateSystem {
            val result = CoordinateSystemFactory.getSystemFor(identifier)
            return (result as io.openmobilemaps.mapscore.shared.map.coordinates.MapCoordinateSystem).asKmp()
        }
    }
}

public fun KMCoordinateSystemFactory.asPlatform(): CoordinateSystemFactory = nativeHandle as CoordinateSystemFactory
