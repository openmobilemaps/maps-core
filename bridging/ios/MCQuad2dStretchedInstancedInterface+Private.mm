...
#import "MCQuad2dStretchedInstancedInterface.h"
...
@interface MCQuad2dStretchedInstancedInterfaceCppProxy : NSObject<MCQuad2dStretchedInstancedInterface>

- (id)initWithCpp:(const std::shared_ptr<::Quad2dStretchedInstancedInterface>&)cppRef;

@end

@implementation MCQuad2dStretchedInstancedInterfaceCppProxy {
    ::djinni::CppProxyCache::Handle<std::shared_ptr<::Quad2dStretchedInstancedInterface>> _cppRefHandle;
}
...
- (void)setStretchInfos:(nonnull MCSharedBytes *)values {
    try {
        _cppRefHandle.get()->setStretchInfos(::djinni_generated::SharedBytes::toCpp(values));
    } DJINNI_TRANSLATE_EXCEPTIONS()
}
...
class Quad2dStretchedInstancedInterface::ObjcProxy final
: public ::Quad2dStretchedInstancedInterface
, private ::djinni::ObjcProxyBase<ObjcType>
{
    friend class ::djinni_generated::Quad2dStretchedInstancedInterface;
public:
    ...
    void setStretchInfos(const ::SharedBytes & c_values) override
    {
        @autoreleasepool {
            [djinni_private_get_proxied_objc_object() setStretchInfos:(::djinni_generated::SharedBytes::fromCpp(c_values))];
        }
    }
...
auto Quad2dStretchedInstancedInterface::toCpp(ObjcType objc) -> CppType
{
    if (!objc) {
        return nullptr;
    }
    if ([(id)objc isKindOfClass:[MCQuad2dStretchedInstancedInterfaceCppProxy class]]) {
        return ((MCQuad2dStretchedInstancedInterfaceCppProxy*)objc)->_cppRefHandle.get();
    }
    return ::djinni::get_objc_proxy<ObjcProxy>(objc);
}

auto Quad2dStretchedInstancedInterface::fromCppOpt(const CppOptType& cpp) -> ObjcType
{
    if (!cpp) {
        return nil;
    }
    ...
    return ::djinni::get_cpp_proxy<MCQuad2dStretchedInstancedInterfaceCppProxy>(cpp);
}
