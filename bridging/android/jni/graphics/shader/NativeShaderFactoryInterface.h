...
private:
    ...
    const jmethodID method_createUnitSphereTessellatedShader { ::djinni::jniGetMethodID(clazz.get(), "createUnitSphereTessellatedShader", "()Lio/openmobilemaps/mapscore/shared/graphics/shader/RasterShaderInterface;") };
