...
private:
    ...
    public:
        ...
        void setTileInfo(int32_t x, int32_t y, int32_t z, int32_t offset) override;
    ...
    const jmethodID method_setTileInfo { ::djinni::jniGetMethodID(clazz.get(), "setTileInfo", "(IIII)V") };
