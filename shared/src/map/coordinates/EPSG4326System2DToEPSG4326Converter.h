...
/// Convert 2D WGS84 display coordinate system to normal WGS84.
class EPSG4326System2DToEPSG4326Converter : public CoordinateConverterInterface {
  public:
    EPSG4326System2DToEPSG4326Converter() {}
    ...
    virtual int32_t getFrom() override { return CoordinateSystemIdentifiers::EPSG4326System2D(); }
