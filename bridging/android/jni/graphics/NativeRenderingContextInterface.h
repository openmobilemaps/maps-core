...
private:
    ...
    public:
        ...
        void setupDrawFrame(const std::shared_ptr<::RenderTargetTexture> & renderTargetTexture) override;
        ...
        void applyScissorRect(const std::optional<::RectI> & scissorRect, const ::RenderPassConfig & pass) override;
    ...
    const jmethodID method_setupDrawFrame { ::djinni::jniGetMethodID(clazz.get(), "setupDrawFrame", "(Lio/openmobilemaps/mapscore/shared/map/RenderTargetTexture;)V") };
    const jmethodID method_endDrawFrame { ::djinni::jniGetMethodID(clazz.get(), "endDrawFrame", "(Lio/openmobilemaps/mapscore/shared/map/RenderTargetTexture;)V") };
    ...
    const jmethodID method_applyScissorRect { ::djinni::jniGetMethodID(clazz.get(), "applyScissorRect", "(Lio/openmobilemaps/mapscore/shared/graphics/common/RectI;Lio/openmobilemaps/mapscore/shared/graphics/RenderPassConfig;)V") };
    const jmethodID method_createRenderTargetTexture { ::djinni::jniGetMethodID(clazz.get(), "createRenderTargetTexture", "()Lio/openmobilemaps/mapscore/shared/map/RenderTargetTexture;") };
};
