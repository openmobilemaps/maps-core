...
#include "NativeFontInfo.h"  // my header
#include "Marshal.hpp"
#include "NativeVec2D.h"

namespace djinni_generated {

NativeFontInfo::NativeFontInfo() = default;

NativeFontInfo::~NativeFontInfo() = default;

auto NativeFontInfo::fromCpp(JNIEnv* jniEnv, const CppType& c) -> ::djinni::LocalRef<JniType> {
    const auto& data = ::djinni::JniClass<NativeFontInfo>::get();
...
auto NativeFontInfo::toCpp(JNIEnv* jniEnv, JniType j) -> CppType {
