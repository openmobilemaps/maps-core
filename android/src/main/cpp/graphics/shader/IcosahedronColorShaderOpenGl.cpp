...
void IcosahedronColorShaderOpenGl::preRender(const std::shared_ptr<::RenderingContextInterface> &context, bool isScreenSpaceCoords) {
    ...
    return OMMVersionedGlesShaderCodeWithFrameUBO(320 es,
                                      ...
                                      void main() {
                                          ...
                                          vec4 adjPos = vec4(1.0 * sin(th) * cos(phi),
                                                             ...
                                                             1.0);
                                          gridValue = vValue;
                                          gl_Position = uFrameUniforms.vpMatrix * adjPos;
                                      }
    );
}
