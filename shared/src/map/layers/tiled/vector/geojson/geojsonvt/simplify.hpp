...
inline double getSqSegDist(const Coord& p, const Coord& a, const Coord& b) {
    double x = a.x;
    double y = a.y;
    double dx = b.x - a.x;
    double dy = b.y - a.y;
...
inline void simplify(std::vector<Coord>& points, size_t first, size_t last, double sqTolerance) {
