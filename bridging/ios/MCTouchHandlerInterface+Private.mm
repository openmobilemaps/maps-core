...
public:
    ...
    void insertListener(const /*not-null*/ std::shared_ptr<::TouchInterface> & c_listener, int32_t c_index) override
    {
        @autoreleasepool {
    ...
    void addListener(const /*not-null*/ std::shared_ptr<::TouchInterface> & c_listener) override
    {
        @autoreleasepool {
            [djinni_private_get_proxied_objc_object() addListener:(::djinni_generated::TouchInterface::fromCpp(c_listener))];
        }
    }
    void removeListener(const /*not-null*/ std::shared_ptr<::TouchInterface> & c_listener) override
    {
        @autoreleasepool {
