...
private:
    ...
    const jmethodID jconstructor { ::djinni::jniGetMethodID(clazz.get(), "<init>", "(Lio/openmobilemaps/mapscore/shared/map/layers/ColorStateList;Lio/openmobilemaps/mapscore/shared/map/layers/ColorStateList;FFLio/openmobilemaps/mapscore/shared/map/layers/SizeType;FLjava/util/ArrayList;FFLio/openmobilemaps/mapscore/shared/map/layers/line/LineCapType;Lio/openmobilemaps/mapscore/shared/map/layers/line/LineJoinType;FZF)V") };
    ...
    const jfieldID field_lineJoin { ::djinni::jniGetFieldID(clazz.get(), "lineJoin", "Lio/openmobilemaps/mapscore/shared/map/layers/line/LineJoinType;") };
