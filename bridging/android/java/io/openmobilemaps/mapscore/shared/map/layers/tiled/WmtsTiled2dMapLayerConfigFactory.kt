...
abstract class WmtsTiled2dMapLayerConfigFactory {
    ...
    companion object {
        @JvmStatic
        fun create(wmtsLayerConfiguration: WmtsLayerConfiguration, zoomLevelInfo: ArrayList<io.openmobilemaps.mapscore.shared.map.layers.tiled.Tiled2dMapZoomLevelInfo>, zoomInfo: io.openmobilemaps.mapscore.shared.map.layers.tiled.Tiled2dMapZoomInfo): io.openmobilemaps.mapscore.shared.map.layers.tiled.Tiled2dMapLayerConfig {
            return CppProxy.create(wmtsLayerConfiguration, zoomLevelInfo, zoomInfo)
        }
    }
