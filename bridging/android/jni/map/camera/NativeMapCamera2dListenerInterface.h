...
private:
    ...
    public:
        ...
        void onCameraChange(const /*not-null*/ std::shared_ptr<::CameraInterface> & camera) override;
    ...
    const jmethodID method_onCameraChange { ::djinni::jniGetMethodID(clazz.get(), "onCameraChange", "(Lio/openmobilemaps/mapscore/shared/graphics/CameraInterface;)V") };
};
