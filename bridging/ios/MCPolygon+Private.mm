...
auto Polygon::toCpp(ObjcType obj) -> CppType
{
    assert(obj);
...
auto Polygon::fromCpp(const CppType& cpp) -> ObjcType
{
    return [[MCPolygon alloc] initWithIdentifier:(::djinni::String::fromCpp(cpp.identifier))
