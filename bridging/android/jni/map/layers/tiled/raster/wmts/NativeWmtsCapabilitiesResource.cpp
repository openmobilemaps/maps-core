...
CJNIEXPORT ::djinni_generated::NativeTiled2dMapRasterLayerInterface::JniType JNICALL Java_io_openmobilemaps_mapscore_shared_map_layers_tiled_raster_wmts_WmtsCapabilitiesResource_00024CppProxy_native_1createLayer(JNIEnv* jniEnv, jobject /*this*/, jlong nativeRef, jstring j_identifier, ::djinni_generated::NativeTextureLoaderInterface::JniType j_textureLoader, ::djinni_generated::NativeMapCoordinateSystem::JniType j_mapCoordinateSystem)
{
    try {
        ...
        auto r = ref->createLayer(::djinni::String::toCpp(jniEnv, j_identifier),
                                  ...
                                  ::djinni_generated::NativeMapCoordinateSystem::toCpp(jniEnv, j_mapCoordinateSystem));
